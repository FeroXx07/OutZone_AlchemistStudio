...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_HOLE][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_HOLE][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_HOLE][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_WALL][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_WALL][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_WALL][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_WALL][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_WALL2][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_WALL2][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_WALL2][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_DOOR][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_DOOR][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_DOOR][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_BOMB][COLLIDER_SPSHIELD] = true;
	matrix[COLLIDER_BOMB][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_BOMB][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_PLAYER][COLLIDER_SPSHIELD] = true;
	matrix[COLLIDER_PLAYER][COLLIDER_POWERUP] = true;
	matrix[COLLIDER_PLAYER][COLLIDER_BOOMBPICKUP] = true;
	...
	matrix[COLLIDER_ENEMY][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_ENEMY][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_ENEMY][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_GREY_ROBOT][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_GREY_ROBOT][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_GREY_ROBOT][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_BIG_RED_MACHINE][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_BIG_RED_MACHINE][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_BIG_RED_MACHINE][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_BLUE_MACHINE][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_BLUE_MACHINE][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_BLUE_MACHINE][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_ORANGE_ROBOT][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_ORANGE_ROBOT][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_ORANGE_ROBOT][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_PURPLE_MACHINE][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_PURPLE_MACHINE][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_PURPLE_MACHINE][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_TURRET1][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_TURRET1][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_TURRET1][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_TURRET3][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_TURRET3][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_TURRET3][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_RED_MACHINE][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_RED_MACHINE][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_RED_MACHINE][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_BOOMBPICKUP] = false;
	//ENERGY
	...
	matrix[COLLIDER_CHANGEAIM][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_CHANGEAIM][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_CHANGEAIM][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_BOX][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_BOX][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_BOX][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_SHIELD][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_SHIELD][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_SHIELD][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_STOP_SHOTS][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_STOP_SHOTS][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_STOP_SHOTS][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_ENERGY][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_ENERGY][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_ENERGY][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_BOSS][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_BOSS][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_BOSS][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_BOSSWEAPON][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_BOSSWEAPON][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_BOSSWEAPON][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_BOSSEYE][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_BOSSEYE][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_BOSSEYE][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_ROLLINGROBOT][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_ROLLINGROBOT][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_ROLLINGROBOT][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_SPSPEED][COLLIDER_SPSHIELD] = false;
	matrix[COLLIDER_SPSPEED][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_SPSPEED][COLLIDER_BOOMBPICKUP] = false;


	matrix[COLLIDER_SPSHIELD][COLLIDER_WALL] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_SPSHIELD][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_ENEMY_SHOT] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_BOMB] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_DOOR] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_WALL2] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_HOLE] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_BOX] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_SHIELD] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_GREY_ROBOT] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_BIG_RED_MACHINE] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_BLUE_MACHINE] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_ORANGE_ROBOT] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_PURPLE_MACHINE] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_TURRET1] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_TURRET3] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_RED_MACHINE] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_STOP_SHOTS] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_ENERGY] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_BOSS] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_BOSSWEAPON] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_BOSSEYE] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_ROLLINGROBOT] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_POWERUP] = false;
	matrix[COLLIDER_SPSHIELD][COLLIDER_BOOMBPICKUP] = false;
	...
	matrix[COLLIDER_POWERUP][COLLIDER_WALL2] = false;
	...
	matrix[COLLIDER_POWERUP][COLLIDER_GREY_ROBOT] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_BIG_RED_MACHINE] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_BLUE_MACHINE] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_ORANGE_ROBOT] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_PURPLE_MACHINE] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_TURRET1] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_TURRET3] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_RED_MACHINE] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_STOP_SHOTS] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_ENERGY] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_BOSS] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_BOSSWEAPON] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_BOSSEYE] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_ROLLINGROBOT] = false;
	matrix[COLLIDER_POWERUP][COLLIDER_BOOMBPICKUP] = false;
	

	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_WALL] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_ENEMY_SHOT] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_BOMB] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_DOOR] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_WALL2] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_HOLE] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_BOX] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_SHIELD] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_GREY_ROBOT] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_BIG_RED_MACHINE] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_BLUE_MACHINE] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_ORANGE_ROBOT] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_PURPLE_MACHINE] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_TURRET1] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_TURRET3] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_RED_MACHINE] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_STOP_SHOTS] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_ENERGY] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_BOSS] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_BOSSWEAPON] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_BOSSEYE] = false;
	matrix[COLLIDER_BOOMBPICKUP][COLLIDER_ROLLINGROBOT] = false;
