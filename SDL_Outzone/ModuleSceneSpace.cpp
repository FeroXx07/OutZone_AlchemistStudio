...
bool ModuleSceneSpace::Start()
{
	...
	App->enemies->AddEnemy(ENEMY_TYPES::GREENROBOT, 50, -120);
	App->enemies->AddEnemy(ENEMY_TYPES::GREENROBOT, 150, -1100);
	App->enemies->AddEnemy(ENEMY_TYPES::GREENROBOT, 170, -1100);
